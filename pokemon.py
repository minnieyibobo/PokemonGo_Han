...
class Pokemon(object):
    ...
    def attack(self, move, target_pokemon):
        ...
        if (move.type == self.type1 or move.type == self.type2):
            damage_dealt *= 1.5
        if (move.type == "fire" and (target_pokemon.type1 == "grass" or target_pokemon.type2 == "grass")):
            damage_dealt *= 2
        elif (move.type == "fire" and (target_pokemon.type1 == "water" or target_pokemon.type2 == "water")):
            damage_dealt *= 0.5
        # Han added code above ========
